...
/**
 * Event raised when a certificate is issued and is ready to be uploaded to FilPass.
 *
...
class begin_filpass_upload extends \core\event\base {
    ...
    public static function get_name() {
        return 'Begin Certificate Upload to FilPass';
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' was issued a certificate (Issue ID: '{$this->objectid}'). The FilPass Integration plugin will now attempt to upload the details to FilPass.";
    }
