...
/**
 * Event raised when a certificate upload to FilPass succeeds.
 *
...
class uploaded_to_filpass extends \core\event\base {
    ...
    public static function get_name() {
        return 'FilPass upload succeeded';
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' was issued a certificate (Issue ID: '{$this->objectid}') and the upload to FilPass completed successfully.";
    }
